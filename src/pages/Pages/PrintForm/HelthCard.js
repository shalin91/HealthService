                  ...
                  <table className="mainTable1">
                    ...
                    <tr>
                      <td>
                        ...
                        <div className="cardDataDiv">
                          <h5 className="cardtitle">
                            Sr.No:{CheckupData?.employeeData?.srNo || "N/A"}{" "}
                          </h5>
                  ...
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeeVitalAndHistory?.height ||
                            "N/A"}{" "}
                        </span>
                  ...
                  <tr>
                    <td>
                      ...
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {" "}
                          {CheckupData?.employeeVitalAndHistory?.weight ||
                            "N/A"}
                        </span>
                        <span style={{ fontSize: "13px", fontWeight: "bold" }}>
                          {" "}
                  ...
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeebloodinformation?.hb || "N/A"}
                        </span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeebloodinformation
                            ?.blSugarPP2BS || "N/A"}
                        </span>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeebloodinformation?.sCreatinine ||
                            "N/A"}
                        </span>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeebloodinformation?.sgpt || "N/A"}
                        </span>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div className="cardDataDiv">
                        ...
                        <span style={{ fontSize: "13px" }}>
                          {CheckupData?.employeebloodinformation?.remarks}
                        </span>
                      </div>
                    </td>
                  </tr>
