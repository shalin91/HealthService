  ...
  return (
    ...
    <Container fluid>
      <div className="mainDivMediclaForm">
        ...
        <div className="srNoDiv">
          Name: {CheckupData?.employeeData?.employeeNameAbbrevation || "N/A"}{" "}
          ...
          <div className="ageSectionDiv">
            ...
            <span>Age:{CheckupData?.employeecontactdetails?.age || "N/A"}</span>
            <span>Yrs</span>
          </div>
        </div>
        <table className="mainTable">
          ...
          <tr>
            ...
            <td colspan="2">{CheckupData?.employeeform32?.reasons || "N/A"}</td>
          </tr>
        </table>
        <table className="mainTable">
          <tr>
          ...
          <tr>
            <td>Sign & Symptoms </td>
            <td colspan="2">{CheckupData?.employeeform32?.signs || "N/A"}</td>
          </tr>
          <tr>
